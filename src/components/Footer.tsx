                ...
                <div className="flex flex-col md:flex-row md:justify-between">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 mt-2">
                            <a href="https://www.facebook.com/share/1BzZwpoy9h/" target="_blank" rel="noopener noreferrer">
                            ...
                            <a href="https://www.instagram.com/sksandeep443?igsh=eHpmMmJjMTlsN2tk" target="_blank" rel="noopener noreferrer">
