...
import { FaArrowCircleRight, FaClipboardList, FaFileSignature, FaScroll, FaTruckLoading } from 'react-icons/fa';
...
export default function DocAnalyzerPage(){
  ...
  const handleAnalyze = async (e: React.FormEvent) => {
    ...
    // The prompt for the Gemini model, instructing it on the task.
    // This prompt is designed to produce a structured, helpful response.
    const prompt = `Analyze the following legal document. Provide a summary of the key clauses, identify any potential risks or important considerations, and explain the language in simple, non-legal terms. Structure the response clearly.
            ...
            <div className="flex-1 w-full bg-gray-900 p-4 rounded-xl overflow-y-auto border border-gray-700 custom-scrollbar">
              ...
              {error && (
                <div className="flex flex-col items-center justify-center h-full text-red-400 p-4">
                  <FaArrowCircleRight className="h-10 w-10 mb-4" />
